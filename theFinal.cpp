...
void mainMinimization(int); //ps
int noOfNodes(); // ps
int noOfAlphabets(); //ps
void storeNodeNames(string*, int, int); // jaitesh
void storeAlphabetNames(string*, int);  // jaitesh
void storeTransition(int**, int, int);  // jaitesh
void graphMatrix(int**, int**, int, int);   //venkata
void closureMatrix(int**, int**, int);  //venkata
void storeStateData(int*, int, int);  //venkata
void removeNonReachables(int**, int*, int, int);  //jayanth
int fsc(int*, int); //jayanth
int nfsc(int*, int); //jayanth
void makeTwoTables(int*, int*, int*, int); //tiruppur nithishvaran
void checkForEqualityInTable(int**, int, int*, int, int*);//tiruppur nithishvaran
int acceptanceNumber();//tiruppur nithishvaran
